...
class _LeaveScreenState extends State<LeaveScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<AppProvider>(context, listen: false).fetchMyLeaves();
    });
  }

  Future<void> _refresh() async {
    await Provider.of<AppProvider>(context, listen: false).fetchMyLeaves();
  }
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.timer_rounded, size: 14, color: Color(0xFF2563EB)),
                                    const SizedBox(width: 4),
                                    Text(
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: const Icon(Icons.date_range_rounded, size: 18, color: Color(0xFF2563EB)),
                              ),
                          ...
                          Container(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Icon(Icons.format_quote_rounded, size: 20, color: Color(0xFF94A3B8)),
                                const SizedBox(width: 12),
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          if (adminComment != null && adminComment.trim().isNotEmpty) ...[
                            ...
                            Container(
                              ...
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Icon(Icons.feedback_rounded, size: 20, color: statusColor),
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
